...
public class TakeAttendance extends AppCompatActivity {
    ...
    String user_type, dept_value, branch_value, sem_value, total_attendance, total_day, dept_data, branch_data2, sem_data, class_data, id_data;
    @Override
...
//
//                TimePickerDialog time_pick = new TimePickerDialog(TakeAttendance.this, R.style.Theme_MaterialComponents_Dialog, new TimePickerDialog.OnTimeSetListener() {
//                    @Override
...
//                        String set_time = format.format(c.getTime());
//                        view_time.setText(set_time);
//                    }
//                }, hour, min, false);
//                time_pick.show();
//            }
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(date_data.isEmpty()){
                    Toast.makeText(TakeAttendance.this, "Please Select Date", Toast.LENGTH_SHORT).show();
                }
//                else if(time_data.isEmpty()){
//                    Toast.makeText(TakeAttendance.this, "Please Select Time", Toast.LENGTH_SHORT).show();
//                }
                else if(dept_data.equals("Select Department")){
                    Toast.makeText(TakeAttendance.this, "Please Select Department", Toast.LENGTH_SHORT).show();
                }else if(branch_data.equals("Select Branch")){
                    Toast.makeText(TakeAttendance.this, "Please Select Branch", Toast.LENGTH_SHORT).show();
                }else if(sem_data.equals("Select Semester")){
                    Toast.makeText(TakeAttendance.this, "Please Select Semester", Toast.LENGTH_SHORT).show();
                }else if(class_data.equals("Select Class Room")){
                    Toast.makeText(TakeAttendance.this, "Please Select Class Room", Toast.LENGTH_SHORT).show();
                    ...
                    Intent i = new Intent(TakeAttendance.this, StudentAttedance.class);
