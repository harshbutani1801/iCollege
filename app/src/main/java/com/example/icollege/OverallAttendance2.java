...
public class OverallAttendance2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overall_attendance2);
...
//                } else
                if (branch_data.equals("Select Branch")) {
                    Toast.makeText(OverallAttendance2.this, "Please Select Branch", Toast.LENGTH_SHORT).show();
                } else if (sem_data.equals("Select Semester")) {
                    Toast.makeText(OverallAttendance2.this, "Please Select Semester", Toast.LENGTH_SHORT).show();
                } else if (class_data.equals("Select Class Room")) {
                    Toast.makeText(OverallAttendance2.this, "Please Select Class Room", Toast.LENGTH_SHORT).show();
                } else {
                    Intent i = new Intent(OverallAttendance2.this, StudentAttendanceOverall.class);
