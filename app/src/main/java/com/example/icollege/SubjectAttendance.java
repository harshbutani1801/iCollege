...
public class SubjectAttendance extends AppCompatActivity {
    ...
    String user_id, dept_value, branch_value, sem_value, user_dept, user_branch;
    @Override
                ...
                for(QueryDocumentSnapshot documentSnapshots : queryDocumentSnapshots) {
                    ...
                    semester.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                            ...
                            mStore.collection(user_dept).document(user_branch).collection(sem_value).document("Semester_Subjects")
...
//                    Toast.makeText(SubjectAttendance.this, "Please Select Department", Toast.LENGTH_SHORT).show();
//                } else if (branch_data.equals("Select Branch")) {
//                    Toast.makeText(SubjectAttendance.this, "Please Select Branch", Toast.LENGTH_SHORT).show();
//                } else
                if (sem_data.equals("Select Semester")) {
                    Toast.makeText(SubjectAttendance.this, "Please Select Semester", Toast.LENGTH_SHORT).show();
                } else if (class_data.equals("Select Class Room")) {
                    Toast.makeText(SubjectAttendance.this, "Please Select Class Room", Toast.LENGTH_SHORT).show();
                } else if (subject_data.equals("Select Subject")) {
                    Toast.makeText(SubjectAttendance.this, "Please Select Subject", Toast.LENGTH_SHORT).show();
                } else {
                    Intent i = new Intent(SubjectAttendance.this, StudentAttendanceData.class);
